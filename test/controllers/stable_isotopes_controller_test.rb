...
class StableIsotopesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create stable_isotope' do
    assert_difference('StableIsotope.count') do
      post stable_isotopes_url,
           params: { stable_isotope: { baseline: @stable_isotope.baseline, iso_bone: @stable_isotope.iso_bone,
                                       iso_id: @stable_isotope.iso_id, iso_value: @stable_isotope.iso_value, isotope: @stable_isotope.isotope, ref_iso: @stable_isotope.ref_iso, skeleton_id: @stable_isotope.skeleton_id } }
    end
  ...
  test 'should update stable_isotope' do
    patch stable_isotope_url(@stable_isotope),
          params: { stable_isotope: { baseline: @stable_isotope.baseline, iso_bone: @stable_isotope.iso_bone,
                                      iso_id: @stable_isotope.iso_id, iso_value: @stable_isotope.iso_value, isotope: @stable_isotope.isotope, ref_iso: @stable_isotope.ref_iso, skeleton_id: @stable_isotope.skeleton_id } }
