...
class GeneticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create genetic' do
    assert_difference('Genetic.count') do
      post genetics_url,
           params: { genetic: { data_type: @genetic.data_type, end_content: @genetic.end_content, ref_gen: @genetic.ref_gen,
                                skeleton_id: @genetic.skeleton_id } }
    end
