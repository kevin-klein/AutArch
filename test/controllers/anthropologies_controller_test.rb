...
class AnthropologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anthropology" do
    assert_difference("Anthropology.count") do
      post anthropologies_url, params: { anthropology: { age_as_reported: @anthropology.age_as_reported, age_class: @anthropology.age_class, height: @anthropology.height, pathologies: @anthropology.pathologies, pathologies_type: @anthropology.pathologies_type, sex_consensus: @anthropology.sex_consensus, sex_gen: @anthropology.sex_gen, sex_morph: @anthropology.sex_morph } }
    end
  ...
  test "should update anthropology" do
    patch anthropology_url(@anthropology), params: { anthropology: { age_as_reported: @anthropology.age_as_reported, age_class: @anthropology.age_class, height: @anthropology.height, pathologies: @anthropology.pathologies, pathologies_type: @anthropology.pathologies_type, sex_consensus: @anthropology.sex_consensus, sex_gen: @anthropology.sex_gen, sex_morph: @anthropology.sex_morph } }
